...
if GENERATE_SUDDEN:
    ...
    export_log(log, "data/control-flow/sudden_drift2.xes")
    print("=== sudden ===")
...
if GENERATE_GRADUAL:
    ...
    export_log(log, "data/control-flow/gradual_drift.xes")
    print("=== gradual ===")
    print(log.attributes['drift info'])
    print()
...
if GENERATE_RECURRING:
    ...
    export_log(log, "data/control-flow/recurring_drift.xes")
    print("=== recurring ===")
    print(log.attributes['drift info'])
    print()
...
if GENERATE_INCREMENTAL:
    ...
    export_log(log, "data/control-flow/incremental_drift.xes")
    print("=== incremental ===")
    print(log.attributes['drift info'])
    print()
