...
drifts = [
        ...
        #{"type": "duration", "mode": "sudden", "drift_point": 0.2, "resources": ["res_01", "res_02"], "factor": 2.5},
        #{"type": "pool_size", "mode": "sudden", "drift_point": 0.8, "delta": -2},
        #{"type": "workload", "mode": "sudden", "drift_point": 0.8, "workload_factor": 1.6},
        #{"type": "control_flow", "mode": "sudden", "drift_point": 0.50, "num_activities": 8, "tree_weights": {"sequence": 0.50, "choice": 0.48, "parallel": 0.1, "loop": 0.01}},
